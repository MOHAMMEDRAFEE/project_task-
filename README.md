...
=>Go to another sub-folder,write testbench for the above verilog program written.

![image](https://user-images.githubusercontent.com/93427617/140311791-fa2263c8-bcac-436a-88ec-931893d07749.png)

=>Write the shown command,to be in working file.
...
=>Further,to check for the codes to be errorfree.use the shown command.
...
=>Attach the cmos (program) lib file or liberty file in the proccessing folder.
...
=>For executing verilog frontend.
